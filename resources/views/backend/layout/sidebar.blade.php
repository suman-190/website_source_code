        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" aria-expanded="false" data-target="#submenu-11dsd"
                            aria-controls="submenu-11">
                            <i class="far fa-clone"></i></i>Students
                        </a>
                        <div id="submenu-11dsd" class="collapse submenu" style="">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('admin.student.index') }}"> Students Table </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('admin.setrequest.index') }}"> Requests Table
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->segment(2) == 'income') ? 'active' : '' }}" data-toggle="collapse" aria-expanded="false" data-target="#submenu-133" aria-controls="submenu-133">
                          <i class="far fa-clone"></i></i> Income
                        </a>
                        <div id="submenu-133" class="collapse submenu {{ (request()->segment(2) == 'income') ? 'show' : '' }}" style="">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link {{ ((request()->segment(2) == 'income') && (request()->segment(3) == null)) ? 'active' : '' }}" href="/admin/income">All income </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ ((request()->segment(2) == 'income') && (request()->segment(3) == null)) ? 'active' : '' }}" href="/admin/income-add"> Add income </a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                            data-target="#submenu-2d3" aria-controls="submenu-2d3">
                            <i class="far fa-newspaper"></i>Success Stories</a>
                        <div id="submenu-2d3" class="collapse submenu" style="">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('admin.success_stories.index')}}"> All Success Stories </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('admin.success_stories.create') }}"> Add Success Story </a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false"
                            data-target="#submenu-2ds3" aria-controls="submenu-2ds3">
                            <i class="far fa-users"></i>Team Member</a>
                        <div id="submenu-2ds3" class="collapse submenu" style="">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('admin.team.index')}}"> All Team Member </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('admin.team.create') }}"> Add Team Member </a>
                                </li>
                            </ul>
                        </div>
                    </li>
