    ...
    <div class="row">
        <div class="col-md-6 mx-auto col-12">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form action="{{ route('message.update', $data['id']) }}" id="" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text"  name="message" class="form-control" id="summernote" placeholder="message">{{$data['message']}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="catname">education</label>
                            <input type="text" value="{{$data['education']}}"  name="education" class="form-control" id="catname12" placeholder="education">
                        </div>
                        <div class="form-group">
                            <label for="catname">course_id</label>
                            <input type="text" value="{{$data['course_id']}}"  name="course_id" class="form-control" id="catname12" placeholder="course_id">
                        </div>
                        <div class="form-group">
                            <label for="catname">college_id</label>
                            <input type="text" value="{{$data['college_id']}}"  name="college_id" class="form-control" id="catname12" placeholder="college_id">
                        </div>
                        <div class="form-group">
