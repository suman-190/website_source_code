...
<div class="container-fluid  dashboard-content">
    ...
    <form action="{{ route('post.store') }}" id="" method="POST" enctype="multipart/form-data">
        @csrf
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="post_title" class="form-control" id="catname12" placeholder="post_title">
                        </div>
                        <div class="form-group">
                            <label for="catname">Sub Title or Export</label>
                            <input type="text" name="post_export" class="form-control" id="catname12" placeholder="post_export">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea  type="text" name="post_content" class="form-control" id="summernote" placeholder="post_content"></textarea>
                        </div>
                        {{-- <div class="form-group">
                            <label for="catname">Post Slug</label>
                            <input type="text" name="post_slug" class="form-control" id="catname12" placeholder="post_slug">
                        </div> --}}
            ...
            <div class="card">
                ...
                <div class="tab-content  pl-3 pt-2" id="myTabContent">
                    <div class="tab-pane fade show active text-align form-new" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            {{-- <div class="form-group">
                                <input type="checkbox"  class="d-inline"  name="is_main" value="1" id="is_main">
                                <label class="nested_label" for="is_main">Is Main</label>
                            </div> --}}
                            <hr>
                            {{-- <div class="form-group">
                                <input type="checkbox"  class="d-inline"  name="is_featured" value="1" id="is_featured">
                                <label class="nested_label" for="is_featured">Is BREAKING</label>
                            </div> --}}
                            {{-- <div class="form-group">
                                <input type="datetime-local"  class="d-inline form-control"  name="feature_date" id="date">
                            </div> --}}
                    </div>
                </div>
            </div>
