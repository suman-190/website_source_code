    ...
    <div class="row">
        <div class="col-md-6 mx-auto col-12">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form action="{{ route('video.store') }}" id="" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="catname">Title (*Optional)</label>
                            <input type="text" name="name" class="form-control" id="catname12" placeholder="title">
                        </div>
                        <div class="form-group">
                            <label for="catname"> Video Src </label>
                            <input type="text" name="video" class="form-control" id="catname12" placeholder="<iframe></iframe>">
                        </div>
                        <div class="form-group">
