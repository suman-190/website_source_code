    ...
    <div class="row">
        <div class="col-md-6 mx-auto col-12">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form action="{{ route('subcategory.update', $data['id']) }}" id="" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <select name="category" id="category" class="form-control">
                                ...
                                <option value="{{ $categorys->id }}"
                                    {{ $categorys->id == $data['parent_id'] ? 'selected' : '' }}>{{ $categorys->name }}
                                </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="type" class="form-control" id="catname12">
                                ...
                                <option value="Civil Engineering"
                                    {{ $data['type'] == 'Civil Engineering' ? 'selected' : '' }}>Civil Engineering
                                </option>
                                <option value="Computer Engineering"
                                    {{ $data['type'] == 'Computer Engineering' ? 'selected' : '' }}>Computer Engineering
                                </option>
                            </select>
                        </div>
                        <div class="form-group">
