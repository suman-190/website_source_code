    ...
    <div class="row">
        <div class="col-md-6 mx-auto col-12">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form action="{{ route('income.store') }}" id="" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="catname">Amount</label>
                            <input type="number" name="amount" class="form-control" id="catname12" value="PPSG" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="catname">Full name</label>
                            <input type="text" name="name" value="" class="form-control" id="catname12" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="catname">Remark</label>
                            <input type="text" name="remark" value="" class="form-control" id="catname12" placeholder="">
                        </div>
                        <div class="form-group">
