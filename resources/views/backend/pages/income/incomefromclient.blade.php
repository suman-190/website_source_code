        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                {{-- <div class="card-header">
                    <h5 class="mb-0 text-center p-2"> Filter Income Details </h5>
                    <hr>
                    <div class="card-body">
                ...
                <div class="card-header">
                    <h5 class="mb-0 text-center p-2"> All Income List - {{ $clent->name }}, {{ $clent->customer_id }} </h5>
                    <a href="{{ url('/admin/income-add')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add New income</a>
                </div>
                <div class="card-body">
                        ...
                        <table id="example" class="table table-striped table-bordered second" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> {!! $user->remark !!} </td>
                                    <td> {{ $user->name }} </td>
                                    <td> {{ $user->clientname ? $user->clientname->name:'' }} - {{ $user->clientname ? $user->clientname->customer_id:'' }} </td>
