    ...
    <div class="row">
        <div class="col-md-6 mx-auto col-12">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form action="{{ route('ads.store') }}" id="" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="subcategorysubcategory"> Select Ads Position </label>
                            <select name="adsposition_id" id="adsposition" class="form-control">
                                @foreach ($adsposition as $adsposition)
                                    <option value="{{ $adsposition->id }}">{{ $adsposition->title }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {{-- <button type="button" id="open_model" class="waves-effect" data-toggle="modal" data-target="#Modal-taza">
                            <i class="far fa-clock"></i><label for="image">Choose Image</label>
                            </button> --}}
                        </div>
                        <div class="form-group">
                            {{-- <label for="image">Ads Image</label> --}}
                            <input type="hidden" name="image" placeholder="" autocomplete="off" class="form-control" id="ads_image" />
                            <input type="hidden" name="image_alt" placeholder="" autocomplete="off" class="form-control" id="ads_alt_image" />
                            <input type="hidden" name="image_caption" placeholder="" autocomplete="off" class="form-control" id="ads_caption_image" />
                            <img id="image_show" name="image" style="width: 50%;padding:5px;" src="#" alt="your image" />
                        </div>
                        {{-- <div class="form-group">
                            <label for="catname"> Ads Title </label>
                            <input type="text" name="title" class="form-control" id="catname12" placeholder="title">
                        </div> --}}
                        {{-- <div class="form-group">
                            <label for="catname"> Ads Display From :  </label>
                            <input type="date" name="display_from" class="form-control" value="{{ now()->format('Y-m-d') }}" id="catname12" placeholder="title">
                        </div> --}}
                        {{-- <div class="form-group">
                            <label for="catname"> Ads Display To :  </label>
                            <input type="date" name="display_to" class="form-control" value="{{ now()->format('Y-m-d') }}" id="catname12" placeholder="title">
                        </div> --}}
                        <div class="form-group">
                            <label for="catname"> Url </label>
                            <input type="text" name="url" class="form-control" id="catname12" placeholder="name">
                        </div>
                        <div class="row">
